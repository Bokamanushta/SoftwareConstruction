...
<span style="font-size:30px;cursor:pointer;color:white;" onclick="openNav()">&#9776;</span>
          ...
          <div class="row">
            <div class="col-md-6 d-flex justify-content-start">
              ...
              <div class="footer-copyright text-center bg-transparent">
                ...
                <a href="#" style="color:black"><b>/ About</b></a>&ensp;
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="team-section text-center dark-grey-text">
    ...
    <!-- Section heading -->
    <h3 class="font-weight-bold pb-2 mb-4"></h3>
    <!-- Section description -->
    <p style="font-size:25px" class="w-responsive mx-auto mb-5">UTM Class Management system offers UTM
    ...
    <h3 class="font-weight-bold pb-2 mb-4">The Whole Team</h3>
    <br>
    <!-- Grid row-->
